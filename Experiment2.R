#in this experiment we consider what happens
#when n/p is not constant
...
baseline <- 2*seq(50, 120, by =  1)
baseline <- as.data.frame(baseline)


#plotting the results

Legend <- c("Increasing Ratio" = "blue", "Decreasing Ratio" = "green", "Shape-of-Upper-Bound" = "red")

ggplot(ratio1, aes(x = seq(50, 120, by = 10), y = ratio1, color = "Increasing Ratio")) +
  geom_smooth(se = FALSE) +
  geom_smooth(data = ratio2, mapping = aes(x = seq(50, 120, by = 10), y = ratio2, color = "Decreasing Ratio"), se = FALSE) +
  geom_line(data = baseline, mapping = aes(x = seq(50, 120, by =  1), y = 0.04*baseline, color = "Shape-of-Upper-Bound")) +
  geom_hline(yintercept = exp(1), linetype = "dashed", color = "purple") +
  labs(
    x = "n",
    y = "Exponential of Ratio Squared",
    title = "Comparison of Experimental & Theoretical Results For n/p Non Constant"
  ) +
...
ggplot(ratio1, aes(x = seq(50, 120, by = 10), y = ratio1, color = "Increasing Ratio")) +
  geom_line() +
  geom_line(data = ratio2, mapping = aes(x = seq(50, 120, by = 10), y = ratio2, color = "Decreasing Ratio")) +
  geom_line(data = baseline, mapping = aes(x = seq(50, 120, by =  1), y = 0.04*baseline, color = "Shape-of-Upper-Bound")) +
  geom_hline(yintercept = exp(1), linetype = "dashed", color = "purple") +
  labs(
    x = "n",
